...
true_gt_file = input_dir + "train_CodeLlama-7b-hf_victim_lowercase_infer.txt"
false_gt_file = input_dir + "train_CodeLlama-7b-hf_victim_lowercase_infer.txt"

# Load data
print("Loading data...")
true_data = load_txt(true_file)
false_data = load_txt(false_file)
true_gt_data = load_txt(true_gt_file)
false_gt_data = load_txt(false_gt_file)
...
true_gt_values = true_gt_data
false_gt_values = false_gt_data
